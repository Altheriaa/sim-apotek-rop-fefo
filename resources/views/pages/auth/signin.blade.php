...
@section('content')
    <div class="relative z-1 flex min-h-screen w-full items-center justify-center bg-gray-50 p-6 dark:bg-gray-950">
        ...
        <div
            ...
            @if ($errors->any())
                <div
                    class="mb-6 rounded-lg border border-error-300 bg-error-50 px-4 py-3 text-sm text-error-600 dark:border-error-500/30 dark:bg-error-500/10 dark:text-error-400">
        ...
        <div class="fixed right-6 bottom-6 z-50">
            <button
                class="bg-brand-500 hover:bg-brand-600 inline-flex size-14 items-center justify-center rounded-full text-white transition-colors shadow-lg"
