...
<div class="space-y-6">
    ...
    <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-800 dark:text-white/90">Tambah Data Supplier</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400">Masukkan informasi pemasok obat yang baru.</p>
        </div>
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="text" id="kontak" name="kontak" value="{{ old('kontak') }}" required
                           class="h-11 w-full rounded-lg border border-gray-200 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/20 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-gray-500 dark:focus:border-brand-500 transition duration-150"
                           placeholder="Gunakan awalan 08 atau 62, Contoh: 08123456789">
                    <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">Nomor ini digunakan untuk mengirim pesan peringatan ROP via WhatsApp.</p>
                </div>
