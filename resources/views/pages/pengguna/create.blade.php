        ...
        <div class="rounded-2xl border border-gray-200 bg-white shadow-theme-sm dark:border-gray-800 dark:bg-gray-dark">
            <form action="{{ route('pengguna.store') }}" method="POST" class="p-6">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <!-- Nama Lengkap -->
                    <div>
                        <label for="email" class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">Email
                            Lengkap</label>
                        <input type="email" id="email" name="email" value="{{ old('email') }}" required
                            ...
                            placeholder="Contoh: user@testing.com">
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select id="role" name="role" required
                                ...
                                <option value="owner" {{ old('role') == 'owner' ? 'selected' : '' }} class="dark:bg-gray-900">
                                    Owner</option>
                                <option value="admin" {{ old('role') == 'admin' ? 'selected' : '' }} class="dark:bg-gray-900">
                                    Admin</option>
