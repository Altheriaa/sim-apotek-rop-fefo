    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">Daftar pesanan otomatis yang digenerate oleh sistem ROP
                    (Reorder Point).</p>
            </div>
        ...
        <div class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-theme-xs dark:border-gray-800 dark:bg-gray-dark">
            ...
            <div class="border-b border-gray-100 p-4 sm:p-5 dark:border-gray-800">
                <form action="{{ route('pesanan.index') }}" method="GET" class="flex flex-col gap-3.5">
                    <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="search" value="{{ request('search') }}"
                                placeholder="Cari #ID, supplier, obat..."
                        ...
                        <!-- Status Filter Dropdown with Custom Chevron -->
                        <div class="relative">
                            <select name="status" onchange="this.form.submit()"
                                ...
                                <option value="draft" {{ request('status') === 'draft' ? 'selected' : '' }} class="dark:bg-gray-900">Draft</option>
                ...
                <table class="w-full min-w-[850px] text-left">
                    <thead>
                        <tr class="border-b border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-800/20">
                            ...
                            <th class="px-5 py-3 text-sm font-medium text-gray-500 dark:text-gray-400">Total Jumlah</th>
                                    ...
                                    <div class="flex items-center gap-1.5">
                                        ...
                                        @if($pesanan->isDraft())
                                            <form action="{{ route('pesanan.destroy', $pesanan->id) }}" method="POST" class="inline"
                                                onsubmit="return confirm('Yakin ingin membatalkan & menghapus pesanan draft ini?')">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
