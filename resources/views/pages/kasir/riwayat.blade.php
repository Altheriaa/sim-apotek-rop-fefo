    ...
    <div class="space-y-6">
        ...
        @if($totalPendapatan > 0)
            <div
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-xs text-brand-600 dark:text-brand-400">Total Pendapatan (Filter Aktif)</p>
        ...
        <div
            ...
            <div class="border-b border-gray-100 p-4 sm:p-5 dark:border-gray-800">
                <form action="{{ route('riwayat-penjualan.index') }}" method="GET"
                    ...
                    <div class="flex flex-1 flex-col gap-3 sm:flex-row sm:items-center">
                        ...
                        <div class="w-full sm:w-40">
                            <input type="date" name="tanggal_dari" value="{{ request('tanggal_dari') }}"
                                class="h-10 w-full rounded-lg border border-gray-200 bg-gray-50/50 px-3 text-sm focus:border-brand-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-brand-500/20 dark:border-gray-700 dark:bg-gray-900/60 dark:text-white/90 transition"
                                title="Tanggal Dari">
                        </div>
                        <div class="w-full sm:w-40">
                    ...
                    <div class="flex items-center gap-2">
                        <button type="submit"
                            class="h-10 inline-flex items-center justify-center gap-1.5 rounded-lg bg-brand-500 px-4 text-sm font-medium text-white shadow-theme-xs hover:bg-brand-600 focus:outline-none focus:ring-2 focus:ring-brand-500/30 transition">Filter</button>
                        @if(request()->hasAny(['search', 'tanggal_dari', 'tanggal_sampai']))
                            <a href="{{ route('riwayat-penjualan.index') }}"
                                class="h-10 inline-flex items-center justify-center rounded-lg border border-gray-200 bg-white px-3.5 text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white transition"
                ...
                <table class="w-full min-w-[800px] text-left">
                    <thead>
                        <tr class="border-b border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-800/20">
                            ...
                            <th class="px-5 py-3 text-sm font-medium text-gray-500 dark:text-gray-400 text-right">Total
                                Omzet</th>
                                ...
                                <td class="px-5 py-4 text-center">
                                    <div class="flex items-center justify-center gap-1.5">
                                        ...
                                        <a href="{{ route('kasir.struk', $trx->id) }}" target="_blank"
                                            class="inline-flex items-center justify-center h-8 w-8 rounded-lg border border-gray-200 bg-white text-brand-500 hover:bg-brand-50 hover:text-brand-600 dark:border-gray-700 dark:bg-gray-800 dark:text-brand-400 dark:hover:bg-brand-900/30 transition"
                                            title="Cetak Struk (Tab Baru)">
